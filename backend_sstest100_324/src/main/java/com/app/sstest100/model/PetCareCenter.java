package com.app.sstest100.model;
...
import com.app.sstest100.converter.DurationConverter;
import com.app.sstest100.converter.UUIDToByteConverter;
import com.app.sstest100.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"sstest100_282\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"sstest100_282\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"sstest100_282\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"sstest100_282\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"sstest100_282\"")
